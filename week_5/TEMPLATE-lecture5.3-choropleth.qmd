...
base_map <- ggplot(joined_precip_geom)+
  ...
  labs(title = "5-year precipitation compared to the 20th century average", 
       ...
       caption = "Source: National Centers for Environmental Imformation")+
  theme_void()+
  theme(
...
my_brew_palette10 <- brewer.pal(n = 10, name = "BrBG") #n = 10 so that 0 sits at the intersection of two colors so greater or less than values are given a color rather than white gradient like before
